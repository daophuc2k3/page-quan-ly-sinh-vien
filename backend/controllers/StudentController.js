...
exports.getAllStudents = async (req, res) => {
    try {
        const students = await studentService.getAllStudents(req.query.page, req.query.cap);
        const total = await studentService.getStudentCount();
        res.json({ data: students, total: total, status: "success" });
    } catch (err) {
...
exports.getStudentById = async (req, res) => {
    try {
        const student = await studentService.getStudentById(req.query.sid);
        res.json({ data: student, status: "success" });
